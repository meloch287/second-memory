...
export const PREMIUM = {
  ...
  // Личный тренер: строки экрана
  star: { id: '5845985728680433961', fallback: '🌟' }, // параметры тела
  target: { id: '5310278924616356636', fallback: '🎯' }, // цель и уровень
  days: { id: '5274055917766202507', fallback: '🗓' }, // дни тренировок
  pen: { id: '5197269100878907942', fallback: '✍️' }, // план / профиль
  // Личный тренер: кнопки
  eye: { id: '5203973454633654910', fallback: '👁️' }, // мой план
  bolt: { id: '5436287209177112914', fallback: '⚡' }, // составить план
  food: { id: '5433747564950215220', fallback: '🧛' }, // питание

  // Заголовки внутренних экранов
  wishHeader: { id: '5274052726605489913', fallback: '😉' }, // вишлист
};
