...
export const COMMANDS = [
  ...
  { command: 'settings', description: 'Личный кабинет: статистика, долги, вишлист' },
  { command: 'reset', description: 'Стереть мою память и начать заново' },
];

// В группах меню своё: личного кабинета там нет, зато есть итоги по чату.
export const GROUP_COMMANDS = [
  { command: 'summary', description: 'Итоги по чату: о чём базарили, что решили' },
  { command: 'help', description: 'Что я умею в этом чате' },
  { command: 'reset', description: 'Стереть память группы (только админ)' },
];

// Текстовые триггеры личного кабинета (U3a-ui): «настройки», «лк», «кабинет»...
// целым сообщением (без хвоста), иначе дневниковые фразы ловились бы по ошибке.
export const LK_TRIGGER_RE = /^(?:мои |моя )?(?:настройки|настройка|лк|кабинет|личный кабинет)[.!?]*$/;
