...
// Реэкспорт функций, вынесенных в ai-skills.mjs. Через именованные const,
// а не `export * from`, чтобы статический аудит (refaudit.test.mjs) видел
// в тексте этого файла определение каждой функции - как и раньше, до выноса
// тел функций в отдельный модуль. Поведение не меняется: это просто ссылки
// на те же функции.
import {
