...
const STALLING = [
  /(?:щас|сейчас|счас)\s+(?:прям\s+|уже\s+|всё\s+|все\s+|тебе\s+|пару\s+)*(?:гляну|посмотрю|поищу|найду|проверю|уточню|скину|пришлю|накидаю|сделаю|напишу|дам|дописываю|минут|секунд)/i,
