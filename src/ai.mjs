...
const GROUP_TASK =
  '\n\nПодведи итоги по чату за сегодня. Структура: «💬 О чём базарили» - 2-4 пункта по темам, с именами кто что сказал; «✅ Что решили» - договорённости (пропусти, если не было); «⏳ Что висит» - открытые дела и долги (пропусти, если пусто). Имена бери ТОЛЬКО из списка участников выше: имя, @ник и прозвище одного человека - это один человек, не разводи его на двоих. Кого нет в списке - того нет в чате. Заголовки пиши ровно как выше, с заглавной буквы и эмодзи - манера общения касается только строк под ними. Если за сегодня тишина - так и скажи, коротко.';
