...
import { capabilitiesLine, featureState, stylePref, toneBlock } from './capabilities.mjs';
...
export function friendSystem(user) {
  ...
  return (
    ...
    'Если человек удивился ответу или поправил тебя, признай это просто, без оправданий на абзац. Реагируй на эмоции, сочувствуй, иногда задавай один короткий встречный вопрос. ' +
    ...
    capabilitiesLine() +
    'Если просят это не дословной командой - не спорь, подскажи нужную фразу. Если просят ответить/записать ГОЛОСОМ - НИКОГДА не говори «я только пишу» или «нет такой функции»: просто ответь по сути, твой ответ сам уйдёт голосовым автоматически. ' +
